...
public class SharedPreferencesUtil {
    ...
    public static void saveAppKey(Context context, String value) {
        sharedPreferences=null;
        SharedPreferences sharedPreferences = context.getSharedPreferences(CONFIG, Context.MODE_PRIVATE);

        sharedPreferences.edit().putString("sobotappsdk", value).apply();
    }

    public static String getAppKey(Context context,  String defValue) {
        ...
        return sharedPreferences.getString("sobotappsdk", defValue);
    }


    public static void saveStringData(Context context, String key, String value) {
        if (sharedPreferences == null) {
            sharedPreferences = context.getSharedPreferences(CONFIG + getAppKey(context,""), Context.MODE_PRIVATE);
        }
