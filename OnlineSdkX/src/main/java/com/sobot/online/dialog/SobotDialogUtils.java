...
public class SobotDialogUtils {
    ...
    public static void startProgressDialog(Context context) {
        ...
        if (progressDialog == null) {
            progressDialog = new SobotLoadingDialog(context, SobotResourceUtils.getResString(context, "online_loading"));
        } else {
            progressDialog.setmMessage(SobotResourceUtils.getResString(context, "online_loading"));
        }
