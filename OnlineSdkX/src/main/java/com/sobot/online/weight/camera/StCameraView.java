...
//        a.recycle();
    ...
    private void initAttrs() {
        ...
        iconSrc = SobotResourceUtils.getDrawableId(getContext(), "sobot_ic_camera");
        iconLeft = SobotResourceUtils.getDrawableId(getContext(), "sobot_ic_back");
        iconRight = 0;
    ...
    private void initView() {
        ...
        View view = LayoutInflater.from(getContext()).inflate(SobotResourceUtils.getResLayoutId(getContext(),"sobot_camera_view"), this);
        mVideoView = (VideoView) view.findViewById(SobotResourceUtils.getResId(getContext(), "video_preview"));
        mPhoto = (ImageView) view.findViewById(SobotResourceUtils.getResId(getContext(), "image_photo"));
        mSwitchCamera = (ImageView) view.findViewById(SobotResourceUtils.getResId(getContext(), "image_switch"));
...
//            }
//        });
        mCaptureLayout = (CaptureLayout) view.findViewById(SobotResourceUtils.getResId(getContext(), "capture_layout"));
        mCaptureLayout.setDuration(duration);
        mCaptureLayout.setIconSrc(iconLeft, iconRight);
        mFoucsView = (StFoucsView) view.findViewById(SobotResourceUtils.getResId(getContext(), "fouce_view"));
...
//                mFlashLamp.setVisibility(INVISIBLE);
            ...
            public void recordShort(final long time) {
                mCaptureLayout.setTextWithAnimation(SobotResourceUtils.getResString(getContext(),"online_voice_time_short"));
