...
public class StVideoView extends FrameLayout implements SurfaceHolder.Callback, View.OnClickListener
    ...
    private void initView() {
        ...
        View view = LayoutInflater.from(getContext()).inflate(SobotResourceUtils.getIdByName(getContext(), "layout", "sobot_video_view"), this);
        mVideoView = (VideoView) view.findViewById(SobotResourceUtils.getResId(getContext(), "video_preview"));
        mBack = (ImageView) view.findViewById(SobotResourceUtils.getResId(getContext(), "iv_back"));
        ib_playBtn = (ImageButton) view.findViewById(SobotResourceUtils.getResId(getContext(), "ib_playBtn"));
        st_currentTime = (TextView) view.findViewById(SobotResourceUtils.getResId(getContext(), "st_currentTime"));
        st_totalTime = (TextView) view.findViewById(SobotResourceUtils.getResId(getContext(), "st_totalTime"));
        st_seekbar = (SeekBar) view.findViewById(SobotResourceUtils.getResId(getContext(), "st_seekbar"));
        st_progress_container = (LinearLayout) view.findViewById(SobotResourceUtils.getResId(getContext(), "st_progress_container"));
