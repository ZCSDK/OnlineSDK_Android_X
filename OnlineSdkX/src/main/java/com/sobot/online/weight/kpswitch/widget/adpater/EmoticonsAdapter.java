...
public class EmoticonsAdapter<T> extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(getResLayoutId("sobot_chat_bottom_emoticon_item"), null);
    ...
    public int getResId(String name) {
        return SobotResourceUtils.getIdByName(mContext, "id", name);
    }

    public int getResDimenId(String name) {
        return SobotResourceUtils.getIdByName(mContext, "dimen", name);
    }

    public int getResLayoutId(String name) {
        return SobotResourceUtils.getIdByName(mContext, "layout", name);
    }
}