...
public class HtmlTools {
    ...
    public void loadPic(final TextView textView, String source, final String htmlContent,
        ...
        HttpUtils.getInstance().download(source, file, null, new HttpUtils.FileCallBack() {
    ...
    public void setRichText(TextView widget, String content, int color) {
        ...
        while (!TextUtils.isEmpty(content) && content.length() > 5 && "<br/>".equals(content.substring(content.length() - 5, content.length()))) {
