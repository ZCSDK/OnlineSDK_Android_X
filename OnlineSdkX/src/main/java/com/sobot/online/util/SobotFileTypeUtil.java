    ...
    public static int getFileIcon(Context context, int fileType) {
        ...
        switch (fileType) {
            case MSGTYPE_FILE_DOC:
                tmpResId = SobotResourceUtils.getIdByName(context, "drawable", "sobot_icon_file_doc");
                break;
            case MSGTYPE_FILE_PPT:
                tmpResId = SobotResourceUtils.getIdByName(context, "drawable", "sobot_icon_file_ppt");
                break;
            case MSGTYPE_FILE_XLS:
                tmpResId = SobotResourceUtils.getIdByName(context, "drawable", "sobot_icon_file_xls");
                break;
            case MSGTYPE_FILE_PDF:
                tmpResId = SobotResourceUtils.getIdByName(context, "drawable", "sobot_icon_file_pdf");
                break;
            case MSGTYPE_FILE_MP3:
                tmpResId = SobotResourceUtils.getIdByName(context, "drawable", "sobot_icon_file_mp3");
                break;
            case MSGTYPE_FILE_MP4:
                tmpResId = SobotResourceUtils.getIdByName(context, "drawable", "sobot_icon_file_mp4");
                break;
            case MSGTYPE_FILE_RAR:
                tmpResId = SobotResourceUtils.getIdByName(context, "drawable", "sobot_icon_file_rar");
                break;
            case MSGTYPE_FILE_TXT:
                tmpResId = SobotResourceUtils.getIdByName(context, "drawable", "sobot_icon_file_txt");
                break;
            case MSGTYPE_FILE_OTHER:
                tmpResId = SobotResourceUtils.getIdByName(context, "drawable", "sobot_icon_file_unknow");
                break;
            default:
                tmpResId = SobotResourceUtils.getIdByName(context, "drawable", "sobot_icon_file_unknow");
                break;
