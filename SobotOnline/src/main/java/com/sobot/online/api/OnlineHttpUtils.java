...
import com.sobot.common.frame.apiUtils.ZhiChiUrlApi;
import com.sobot.common.frame.http.SobotOkHttpUtils;
import com.sobot.common.frame.http.builder.PostFormBuilder;
import com.sobot.common.frame.http.builder.PostMultipartFormBuilder;
import com.sobot.common.frame.http.callback.StringCallback;
...
import com.sobot.common.frame.http.upload.SobotUpload;
import com.sobot.common.frame.http.upload.SobotUploadTask;
...
public class OnlineHttpUtils {
    ...
    public void doPost(Object cancelTag, final String url_str, final Map<String, String> map,
        ...
        SobotLogUtils.i("请求URL: --> " + url_str);
        SobotLogUtils.i("请求参数: --> " + map);
        SobotLogUtils.i("请求token: --> " + getTokenId(url_str));
        SobotOkHttpUtils
                .post()
                .tag(cancelTag)
                .url(url_str)
            ...
            public void onResponse(String response) {
                SobotLogUtils.i(url_str + "----请求返回结果: --> " + response);
    ...
    private void printLog(String url_str, Map<String, String> map) {
        try {
            ...
            SobotLogUtils.i(sb.toString().substring(0, sb.toString().length() - 2));
        } catch (Exception e) {
            //ignor
        }
    }
    ...
    public void download(String url_str, File file, Map<String, String> map,
        ...
        SobotOkHttpUtils
                ...
                .execute(new com.sobot.common.frame.http.callback.FileCallBack(file.getAbsolutePath()) {
    ...
    public SobotUploadTask addUploadFileTask(String msgTag, String url_str, Map<String, String> map,
        ...
        SobotLogUtils.i("上传文件 请求URL: --> " + url_str);
        SobotLogUtils.i("上传文件 请求参数: --> " + map);
        PostFormBuilder post = SobotOkHttpUtils.post();
        if (!TextUtils.isEmpty(path)) {
            File file = new File(path);
            post.addFile("file", file.getName(), file);
